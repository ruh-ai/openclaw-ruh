        ...
        <div className="flex flex-wrap gap-2">
          {quickReplies.map((option) => (
            <button
              ...
              className="px-3 py-1.5 rounded-md text-sm font-medium border border-[#e2e2e2] bg-[#f3f4f6] text-[#3c3a3d] hover:border-[#ae00d0] hover:text-[#ae00d0] hover:bg-[#f9f3ff] transition-all duration-200 cursor-pointer"
            >
              {option}
            </button>
          ))}
