#!/usr/bin/env python3
"""Thin client for the data-ingestion-openclaw service.
...
Key endpoints (as documented by data-ingestion-openclaw SKILL.md in standard OpenClaw setups):
- POST /data/query
...
def build_upsert_item(*, schema_type: str, table: str, rows: List[Dict[str, Any]], conflict_keys: Optional[List[str]] = None) -> Dict[str, Any]:
    item: Dict[str, Any] = {
        "schema_type": schema_type,
        "table": table,
        "operation": "upsert",
