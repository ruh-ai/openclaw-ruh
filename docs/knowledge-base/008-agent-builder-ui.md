  ...
  (platform)/                     — Main authenticated area
    ...
    agents/
      ...
      create/
        ...
        _components/copilot/LifecycleStepRenderer.tsx — 7-stage lifecycle stepper UI (embeds MeetYourEmployee for Reveal)
