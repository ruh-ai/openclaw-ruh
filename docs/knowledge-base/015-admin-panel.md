...
Next.js 15 admin dashboard at `admin-ui/` (port 3002) for Ruh platform management. Requires admin role. Covers user management, agent oversight, marketplace moderation, and system health.

## Related Notes
- [[014-auth-system]] — Admin role and auth middleware
...
| Route | Purpose |
|-------|---------|
| `/login` | Admin login (validates role=admin after auth) |
